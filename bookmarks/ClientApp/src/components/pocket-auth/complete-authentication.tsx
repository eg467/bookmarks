...
export interface CompleteAuthenticationProps extends ConnectedProps {
}

const CompleteAuthentication: React.FC<CompleteAuthenticationProps> = ({ continueAuthentication, username }) => {
