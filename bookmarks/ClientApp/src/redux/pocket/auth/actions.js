...
var promise_middleware_1 = require("../../../redux/middleware/promise-middleware");
// ACTIONS
var ActionType;
(function (ActionType) {
...
exports.actionCreators = {
    ...
    initAuthentication: function () {
        return function (dispatch) {
            return dispatch({
                ...
                promise: function () { return pocket_api_1.default.getRequestToken().catch(function (error) {
                    pocket_api_1.default.logout();
                    throw error;
                }); }
            });
     ...
     */
    continueAuthentication: function () {
        return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!pocket_api_1.default.requiresAuthorization) return [3 /*break*/, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, dispatch(promise_middleware_1.createPromiseAction({
                                ...
                                promise: function () { return pocket_api_1.default.getAccessTokenFromRequestToken(); }
                            }))];
                    case 2:
                        _a.sent();
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, !!pocket_api_1.default.isAuthenticated];
                }
            });
        }); };
    }
